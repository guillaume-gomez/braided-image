...
function Footer() {
  return (
    <footer className="py-2 px-4 bg-primary text-black">
      <div className="flex flex-row justify-between items-center">

        <p> 2023 - Made By Guillaume Gomez</p>
        <div className="flex flex-row items-center gap-2">
          <a aria-label="Github" target="_blank" rel="noreferrer" href="https://github.com/guillaume-gomez/woven-images" className="btn btn-accent btn-sm btn-square btn-secondary">
          ...
          <a href="https://github.com/guillaume-gomez/woven-images">Did you enjoyed ? 😊 Star the project </a>
        </div>
      </div>
    </footer>
  );
