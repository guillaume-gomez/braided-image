...
function Footer() {
  return (
    <footer className="py-2 px-4 bg-base-300 text-base-content">
      <div className="flex flex-row justify-between items-center">

        <p className="text-xs"> 2022 - Made By Guillaume Gomez</p>
        <div className="flex flex-row items-center gap-2">
          <a aria-label="Github" target="_blank" rel="noreferrer" href="https://github.com/guillaume-gomez/woven-images" className="btn btn-sm btn-square">
          ...
          <a href="https://github.com/guillaume-gomez/woven-images" className="text-xs">Did you enjoyed ? 😊 Star the project </a>
        </div>
      </div>
    </footer>
  );
