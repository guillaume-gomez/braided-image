...
function Drawer() {
  return (
    <div className="navbar py-4 bg-primary text-base-100">
     <img className="rounded-lg" src={process.env.PUBLIC_URL + '/logo192.png'} width="64px" />
      ...
      <div className="navbar-end flex gap-2">
        <a aria-label="Github" target="_blank" rel="noreferrer" href="https://github.com/guillaume-gomez/woven-images" className="btn btn-accent btn-square">
