...
function Drawer() {
  return (
    <div className="navbar mb-2 bg-neutral-focus text-neutral-content">
     <img className="rounded-lg" /*src={Logo}*/ width="64px" />
      ...
      <div className="navbar-end flex gap-2">
        <a aria-label="Github" target="_blank" rel="noreferrer" href="https://github.com/guillaume-gomez/woven-images" className="btn btn-primary btn-square">
